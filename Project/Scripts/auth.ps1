...
$env:GOOGLE_APPLICATION_CREDENTIALS="D:\Cosas Personales\Trabajo Final\Proyecto\Project\Scripts\Credentials\odiseo-chatbot-5749349920e9.json"
...
Invoke-Expression 'cmd /c start powershell -Command { 
    ...
    cd "D:\Cosas Personales\Trabajo Final\Proyecto\Project";
    $env:GOOGLE_APPLICATION_CREDENTIALS="D:\Cosas Personales\Trabajo Final\Proyecto\Project\Scripts\Credentials\odiseo-chatbot-5749349920e9.json"
